...
function Search() {
    ...
    const debouncedValue = useDebounce(searchValue, 600); // decounce sẽ giữ giá trị hiện tại 600
    ...
    useEffect(() => {
        ...
        const fetchApi = async () => {
            ...
            const result = await searchService.search(debouncedValue); // Gọi hàm tìm kiếm dịch vụ với giá trị đã trì hoãn
            ...
            >
                <div className={cx('search')}>
                    ...
                    <button
                        ...
                        onMouseDown={(e) => e.preventDefault()} // Ngăn chặn các hành động được setup cho việc nhấn chuột. Trong TH này là loại bỏ việc viền khung nhập đen lên khi ta cấu hình
                    >
                        <SearchIcon />
                    </button>
                </div>
